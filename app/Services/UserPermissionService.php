...
/**
 * Сервис для работы с логикой прав пользователей фронтенда
 * Цель: Вынести бизнес-логику из контроллера UserPermissionsController
 */
class UserPermissionService
{
    ...
    /**
     * Валидация данных для создания/обновления права пользователя
    ...
    public function validate(array $data, ?int $existingId = null, bool $isCurrentUserSuperAdmin = false): array
    {
        ...
        if (empty($name)) {
            ...
            $existingPerm = $this->userPermRepo->findByName($name);
    ...
    /**
     * Создание нового права пользователя
    ...
    public function create(array $data)
    {
        ...
        // Создание права в БД
        $permId = $this->userPermRepo->create($permData);
        
        return $permId;
    }

    /**
     * Обновление данных права пользователя
    ...
    public function update(int $id, array $data, bool $isCurrentUserSuperAdmin = false): bool
    {
        ...
        $result = $this->userPermRepo->update($id, $updateData);
