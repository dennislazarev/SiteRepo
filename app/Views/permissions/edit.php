...
<h2>Редактирование права: <?= htmlspecialchars($permission['display_name'] ?? '') ?></h2>
...
<?php if (isset($permission)): ?>
    <form action="/admin/permissions/<?= $permission['id'] ?>" method="POST">
        ...
        <div class="mt-4">
            ...
            <a href="/admin/permissions" class="btn btn-secondary">Отмена</a>
        </div>
    </form>
<?php else: ?>
    <div class="alert alert-danger">Право не найдено.</div>
    <a href="/admin/permissions" class="btn btn-primary">Назад к списку прав</a>
<?php endif; ?>